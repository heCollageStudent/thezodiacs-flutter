...
var zodiacsData = [
  Zodiacs(
      id: 1,
      name: 'Aquarius',
      imgAsset: 'assets/images/icon_aquarius.jpg',
  ...
  Zodiacs(
    id: 2,
    name: 'Aries',
    imgAsset: 'assets/images/icon_aries.jpg',
  ...
  Zodiacs(
    id: 3,
    name: 'Cancer',
    imgAsset: 'assets/images/icon_cancer.jpg',
  ...
  Zodiacs(
    id: 4,
    name: 'Capcricorn',
    imgAsset: 'assets/images/icon_capricorn.jpg',
  ...
  Zodiacs(
    id: 5,
    name: 'Gemini',
    imgAsset: 'assets/images/icon_gemini.jpg',
  ...
  Zodiacs(
    id: 6,
    name: 'Leo',
    imgAsset: 'assets/images/icon_leo.jpg',
  ...
  Zodiacs(
    id: 7,
    name: 'Libra',
    imgAsset: 'assets/images/icon_libra.jpg',
  ...
  Zodiacs(
    id: 8,
    name: 'Pisces',
    imgAsset: 'assets/images/icon_pisces.jpg',
  ...
  Zodiacs(
    id: 9,
    name: 'Sagittarius',
    imgAsset: 'assets/images/icon_sagittarius.jpg',
  ...
  Zodiacs(
    id: 10,
    name: 'Scorpio',
    imgAsset: 'assets/images/icon_scorpio.jpg',
  ...
  Zodiacs(
    id: 11,
    name: 'Taurus',
    imgAsset: 'assets/images/icon_taurus.jpg',
  ...
  Zodiacs(
    id: 12,
    name: 'Virgo',
    imgAsset: 'assets/images/icon_virgo.jpg',
